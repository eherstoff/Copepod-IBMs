#######################################################################
# Last updated: 4 March 2019, EMH and MU
...
helix.steps.LQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.helix.steps.LQ.dat.matrix2   <- matrix(nrow=3, ncol=1)
helix.steps.HQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.helix.steps.HQ.dat.matrix2   <- matrix(nrow=3, ncol=1)

#n steps straight swimming
straight.LQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.straight.LQ.dat.matrix2   <- matrix(nrow=3, ncol=1)
straight.HQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.straight.HQ.dat.matrix2   <- matrix(nrow=3, ncol=1)

#n steps paused/not moving
waiting.steps.LQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.waiting.steps.LQ.dat.matrix2   <- matrix(nrow=3, ncol=1)
waiting.steps.HQ.dat.matrix2        <- matrix(nrow=3, ncol=1)
  sd.waiting.steps.HQ.dat.matrix2   <- matrix(nrow=3, ncol=1)  
...
#This will be used to tell how many steps the simulation needs to keep a cope in a cell when helices happen
  time.hq<-helix.time.hq/time.unit  #observed n frames / standardized n frames = n steps in model to stay looping.
