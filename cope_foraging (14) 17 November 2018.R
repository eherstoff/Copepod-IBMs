...
cell.size.matrix2 <- matrix(nrow=1, ncol=1) #nrow should be rest to x20 for ALL following
...
mean.helix.LQ_na.dat.matrix2 <- matrix(nrow=1, ncol=1)
sd.helix.LQ_na.dat.matrix2   <- matrix(nrow=1, ncol=1)

mean.helix.HQ_na.dat.matrix2 <- matrix(nrow=1, ncol=1)
sd.helix.HQ_na.dat.matrix2   <- matrix(nrow=1, ncol=1)
...
###########################################################################################################
# Start of IBM output plots for paper here
###########################################################################################################
